// components/client/ClientContracts.jsx
...
export const ClientContracts = () => {
  ...
  useEffect(() => {
    fetchData({
      url: `get-client-contracts-with-status?contractStatus=${activeTab}`,
      method: "GET",
    });
  }, [activeTab]);
  ...
  const getTabCount = (status) => {
    // This could be fetched from backend or calculated
            ...
            {contracts.map((contract) => (
              <Col md={6} lg={4} key={contract.id}>
                <Card
                  ...
                  onClick={() =>
                    navigate(`/${RoutePath.CLIENT}/${RoutePath.CONTRACT}/${contract.id}`)
                  }
                >
                  <Card.Body>
                    {/* Post Title */}
                    ...
                    {/* Progress Indicator for Active Contracts */}
                  ...
                  <Card.Footer className="bg-transparent border-0">
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(
                          `/${RoutePath.CLIENT}/${RoutePath.CONTRACT}/${contract.id}`
                        );
                      }}
                    >
                      View Details
