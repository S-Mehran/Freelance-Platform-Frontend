        ...
        {posts.map((post) => (
          <Col md={6} lg={4} key={post.id}>
            <Card
              ...
              onClick={() =>
                navigate(
                  `/${RoutePath.CLIENT}/${RoutePath.SINGLE_POST}/${post.id}`,
                  { replace: true }
                )
              }
            >
...
//       <h2 className="text-center fw-bold mb-4 text-primary">Job Posts</h2>
...
//             onClick={()=>navigate(`${RoutePath.GET_POSTS}/${RoutePath.SINGLE_POST}/${post.id}`, {replace:true})}
//             >
//               <Card.Body>
...
//                   {post.levelofExpertise?.replace("_", " ")}
//                 </Card.Subtitle>
...
//                 </Card.Text>
//                 <div className="d-flex justify-content-between align-items-center mt-3">
//                   <span className="fw-bold text-success">${post.price}</span>
//                   <span className="badge bg-light text-dark">
//                     {post.projectType?.replace("_", " ")}
//                   </span>
//                 </div>
